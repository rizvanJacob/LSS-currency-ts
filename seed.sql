...
INSERT INTO Requirement (name, hasSeniority, rehackPeriod, extensionPeriod, seniorExtension, selfComplete, alsoCompletes, refreshToMonthEnd) VALUES ('DFS (R)', 1, 3, 36, 60, 0, NULL, 1),('DFS (Y)', 1, 0, 12, -1, 0, NULL, 1),('ACE', 0, 4, 12, NULL, 0, NULL, 0),('SVT', 1, 0, 12, -1, 1, NULL, 1),('APT (F)', 1, 0, 36, 60, 0, NULL, 1),('APT (T)', 1, 0, 36, 60, 0, NULL, 1),('APT (H)', 1, 0, 36, 60, 0, NULL, 1),('NVG R (F)', 1, 0, 36, 60, 0, NULL, 1),('EST', 0, 0, 24, NULL, 0, NULL, 1),('Dgy (F)', 0, 0, 24, NULL, 0, NULL, 1),('Dgy (T/H)', 0, 0, 24, NULL, 0, NULL, 1),('HUET', 1, 0, 12, 36, 0, NULL, 1),('NVG R (H)', 1, 0, 36, 60, 0, NULL, 1);
...
UPDATE Requirement SET hasSeniority = 1, seniorExtension = -1 WHERE name = 'SVT'