          ...
          {users.map((user: User) => {
            ...
            return (
              <tr key={user.id} className="hover:bg-gray-100">
                <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-blue-200">{user.displayName}</td>
                <td className={`px-6 py-4 whitespace-nowrap text-sm ${accountTypeClass}`}>{accountType}</td>
