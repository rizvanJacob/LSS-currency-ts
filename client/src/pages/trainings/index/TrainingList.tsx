...
import ShowTrainingButton from "../show/ShowTrainingButton";
                    ...
                    {trainings.map((training: Training) => {
                        return (
                            <tr key={training.id}>
                                ...
                                <td>{training.capacity - Object.keys(training.trainees).length}/{training.capacity}</td>
                                <td>{dayjs(training.start).format("YYYY-MM-DD, HH:mm a")}</td>
                                <td>{dayjs(training.end).format("YYYY-MM-DD, HH:mm a")}</td>
                                <td><ShowTrainingButton training = {training}/></td>
                            </tr>
                        )
                    })}
                </tbody>
